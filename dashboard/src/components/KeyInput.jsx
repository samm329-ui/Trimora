...
const PROVIDER_META = {
  gemini: {
    ...
    docText: 'Get your free Gemini API Key here',
    iconBg: 'bg-accent/20',
  ...
  groq: {
    ...
    docText: 'Get your free Groq API Key here',
    iconBg: 'bg-emerald-500/20',
    iconColor: 'text-emerald-400',
  },
};

export default function KeyInput({ onKeySet, savedKey, provider = 'gemini' }) {
  ...
  return (
    <div className="bg-surface border border-white/5 rounded-2xl p-6 mb-4 animate-[fadeIn_0.5s_ease-out]">
      <div className="flex items-center gap-3 mb-4">
        <div className={`p-2 ${meta.iconBg} rounded-lg ${meta.iconColor}`}>
          <Key size={20} />
        </div>
